                        ...
                        if (result.isConfirmed) {
                            Swal.fire(`${sender} dimata ${nama} seberapa baik ?`).then(function() {
                                Swal.fire({
                                    ...
                                    val = e.value
                                    Swal.fire(`Makasih ya udah jawab pertanyaan ${sender} ${val}%`).then(function() {
                                        Swal.fire({
                                            title: `Sekarang ${nama} lagi mikirin ${sender} ta ?`,
                                            showDenyButton: true,
                                            showCancelButton: false,
                                            confirmButtonText: `iya :(`,
                                            ...
                                            /* Read more about isConfirmed, isDenied below */
                                            if (result.isConfirmed) {
                                                Swal.fire(`Huhu masak si ${nama} , makasihhh yaa`).then(function() {
                                                    Swal.fire('Terakhir deh ').then(function() {
                                                        Swal.fire('Coba klik ikon hati di paling bawah dong')
                                                    })
                                                })
                                            } else if (result.isDenied) {
                                                Swal.fire('yahhh , enggak papa deh huhu', '', 'error').then(function() {
